...
/******************************************************************************/
  ...
  {
    // HCLK = SYSCLK ,HCLK时钟为系统时钟1分频
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;
      
    // PCLK2 = HCLK / 2，APB2时钟为HCLK时钟2分频
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;
    
    // PCLK1 = HCLK / 4,APB1时钟为HCLK时钟4分频
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;

    // 配置主PLL时钟，f(pll_out) = f(pll_in)*PLL_N/PLL_M/PLL_P = 120M
