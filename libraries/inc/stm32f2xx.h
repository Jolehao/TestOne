 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */           
#define HSE_VALUE            ((uint32_t)25000000)//((uint32_t)12000000)   /*!< Value of the External oscillator in Hz */
#define HSE_FREQUENCY        12       /*!< Value of the External oscillator in MHz */
